...
import EscogerEquipos from '../../Remision/EscogerEquipos';
import FilterLogo from '../../../assets/options.svg';
import Row from 'react-bootstrap/Row';
import Col from 'react-bootstrap/Col';
function BuscarEquiposCotizados(props) {
    //Estados globales
    const [equiposSeleccionados, setEquiposSeleccionados] = props.equiposSeleccionados;
    ...
    return (
        <>
            <div className="filtersWrapper">
                <button type="button" className="border-0 bg-transparent no-border-active">
