...
function CotizacionDetailTable(props) {
  ...
  const cobro =
    cotizacionSeleccionada && cotizacionSeleccionada.tarifasCotizadas
      ? CalcularTarifa(cotizacionSeleccionada.tarifasCotizadas)
      : null;
  ...
  return (
    <div>
      <h6 className="mt-4">
        {cotizacionSeleccionada && cotizacionSeleccionada._id
          ? "Id cotización seleccionada: " + cotizacionSeleccionada._id
          : ""}
      </h6>
