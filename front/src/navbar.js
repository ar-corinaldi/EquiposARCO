...
function navigationBar(params) {
    ...
    return (
            <Navbar id="navigationBar" expand="md">
                <Navbar.Brand href="#home" className = 'white'>React-Bootstrap-Logo</Navbar.Brand>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        ...
                        <Nav.Link href="#link" className = 'white'>Link</Nav.Link>
                        <NavDropdown title="Dropdown" id="basic-nav-dropdown" onClick={dropDownHandler}>
